document.addEventListener('DOMContentLoaded', function() {
  ...
  function createDayButtons() {
    ...
    allDaysBtn.type = 'button'; // Add type="button" attribute
    ...
    uniqueDays.forEach(day => {
      ...
      btn.type = 'button'; // Add type="button" attribute
  ...
  function createEventElement(event) {
    ...
    if (event.Keywords) {
      detailsHTML += `<div><strong>Topics:</strong> <div class="sched-keywords-container">`;
